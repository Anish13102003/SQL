...
insert into employee_details values (1,"Naveen","IT",35000,"Chennai");
insert into employee_details (name,department,salary,city) values ("Ranjith","CS",40000,"Pondichery");
...
-- logical operator --
select * from employee_details where not name = "Ranjith";
